...
public:
    ...
    void Update(float deltaTime, Entity *player, Entity *lasers, Entity *enemies, Entity *platforms, int platformCount);
    void Render(ShaderProgram *program);
    void DrawSpriteFromTextureAtlas(ShaderProgram *program, GLuint textureID, int index);
    
    void AI(Entity *player, Entity *lasers);
    void AIWalker();
    void AIShooter(Entity *lasers);
    void AIJumper();
};
